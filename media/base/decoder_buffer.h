 ...
 public:
  ...
  class Allocator {
   public:
    ...
    // |offset| bytes into it. This allows a block to be filled from several
    // source buffers, which a caller cannot do itself because |handle| may be
    // opaque and so cannot be offset.
